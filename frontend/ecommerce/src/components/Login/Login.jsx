...
export const Login = ({ successLogin, handleRegister, handleReset }) => {
        ...
        >
          <Stack spacing="6">
            <Stack spacing="5">
              ...
              <Link textDecoration="underline" color="blue.500" onClick={handleReset}>
            ...
            <Stack spacing="6">
              <Button onClick={(e) => handleGitHub(e)}>
